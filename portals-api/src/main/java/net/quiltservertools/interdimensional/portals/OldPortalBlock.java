...
import net.quiltservertools.interdimensional.portals.client.CustomPortalsModClient;
...
public class OldPortalBlock extends Block {
    ...
    public OldPortalBlock(Settings settings) {
        super(settings);
